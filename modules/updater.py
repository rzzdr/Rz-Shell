...
REMOTE_URL = "https://raw.githubusercontent.com/rzzdr/Rz-Shell/refs/heads/main/version.json"
...
class UpdateWindow(Gtk.Window):
    ...
    def on_update_clicked(self, _widget):
        ...
        if self.pkg_update:
            update_command = "curl -fsSL https://raw.githubusercontent.com/rzzdr/Rz-Shell/main/install.sh | bash"
        else:
